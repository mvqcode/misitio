...
SECRET_KEY = 't+--&skkp-j2g^39ugd%c&-6y-#*$7k3oh)(xes)+k*h#hh4^0'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['Ultinoticias.pythonanywhere.com', '127.0.0.1']
...
INSTALLED_APPS = [
    ...
    'main.apps.MainConfig',  # instalacion de app main
    'tinymce',  # instala la app tinymce
]
